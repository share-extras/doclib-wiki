...
<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/components/wiki2/toolbar.css" group="documentlibrary"/>
...
<@markup id="js">
   ...
   <@script type="text/javascript" src="${url.context}/res/components/wiki2/toolbar.js" group="documentlibrary"/>
</@>
