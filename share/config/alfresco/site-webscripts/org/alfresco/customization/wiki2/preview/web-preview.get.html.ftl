<@markup id="additional-js" target="js" action="after">
   ...
   <@script type="text/javascript" src="${page.url.context}/res/components/preview/Markdown.Converter.js" group="${dependencyGroup}"></@script>
   <@script type="text/javascript" src="${page.url.context}/res/components/preview/Markdown.Sanitizer.js" group="${dependencyGroup}"></@script>
</@>
